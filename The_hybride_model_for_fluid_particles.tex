...
\title{Averaged equations for disperse two-phase flow made of fluid particles with surface properties}
...
\begin{abstract}
    ...
    the particle-average or Lagrangian formalism proposed by \citet{zhang1994ensemble};
    ...
    The second major contribution of this work is the proof of the equivalence between the particle-averaged and phase-averaged equations. 
    We demonstrate that the phase-averaged equation of the dispersed phase is a series expansion of the so-called particle-averaged moments equations. 
    Consequently, as first stated by \citet{zhang1997momentum}, here we proved that by incorporating an arbitrary number of moment equations, we can achieve an arbitrary order of accuracy in the modeling of the dispersed phase.
    Finally, to give it a more physical meaning, we propose to study contaminated rising bubbly flows. 
    Specifically, we demonstrate how to predict the distribution of surfactant over the interface of bubbles, using this particle-averaged hybrid model.
\end{abstract}
...
\section{Lagrangian equation of conservation for the dispersed phase}
...
\input{The_hybride_model/Disscusion.tex}



\section{Disscusion and conclusion}
\input{The_hybride_model/Conclusion.tex}

\section*{Acknowlegement}
We would like to express our sincere gratitude to Professor Lhuillier for his inspiring and insightful class, which has greatly influenced our work.
