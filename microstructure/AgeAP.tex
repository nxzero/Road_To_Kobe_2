...
%\section{Slip velocity between the two phases and shape of the drops}
\section{Deformation of the drops}
\label{ap:deformation} 


\color{blue}
ajouter un graphique montrant la deformation des gouttes. on peut s'inspirer de l'annexe que j'avais mise dans le papier "closure"
\color{black}
%\begin{figure}[h!]
%  \centering
