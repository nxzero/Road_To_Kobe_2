...
\begin{figure}
    \centering
    \begin{tikzpicture}[scale=0.35,ultra thick]
...
Nevertheless, we believe that further developments, which are referenced at \href{http://basilisk.fr/sandbox/fintzin/Rising-Suspenion/no-coalescence.h}{no-coalescence.h}, might be useful for future studies.\tb{mettre latodo list}
\begin{figure}[h!]
    \centering
    \begin{tikzpicture}
...
\tb{mettre le cout de calcul associé au VoF N(t) : dtrace=-2 et plus generalement plus de details sur le cout de calculs }
