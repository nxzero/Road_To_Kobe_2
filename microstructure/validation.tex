...
The \texttt{Basilisk} code has been validated numerous time in previous numerical studies \todo{Add biblio}\citet{innocenti2020direct},\citet{popinet2018numerical} \JL{Popinet 2018 n'est pas la bonne reference. C'est une revue generale sur la simulation des ecoulements capillaires pas des tests Basilisk. Tu peux citer certains papiers ou il y a des ecoulements avec inclusions multiples.}. 
...
\subsubsection{Buoyant fixed array of bubbles}
Objectives :
\begin{itemize}
...
\todo[inline]{we could compare with bubbly flow of \citet{zhang2021direct}/\citet{roghair2011drag} \textbf{multi-vof} ? ?  non pas necessaire.}
