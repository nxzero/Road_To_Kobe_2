...
Nevertheless, we suspect that this arises from neglecting the ``outer'' solution, which seems to be accounted for in \citet{taylor1964deformation}, although, following the reasoning of \citet{stone2001inertial}, it should be negligible. 
...
Additionally, we can remark that the deformation measured by the DNS results is nearly independent of the volume fraction $\phi$, and depends on $We$ linearly. 
...
Again it might be interesting to compare 
