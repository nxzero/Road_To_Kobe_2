...
Notice that $\int_{\Sigma_\alpha} \textbf{r}c_Id\Sigma =  \frac{s_\alpha}{4 \pi}\int_{\Sigma_\alpha} \nablabhI (c_I) d\Sigma$, thus $\textbf{r}_\alpha$ can also be interpreted as the mean gradient of surfactant on a particle's surface.
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[scale =1.3]
        ...
        \draw[red!70!black, ->](110:-1.2)--++(110:-0.2)node[below]{$\textbf{n}_2 \cdot \nablabh c_1$};
    \end{tikzpicture}
    \hspace{2em}
...
\tb{The diffusive terms change in function of the regime : dilute concentration / saturated concentration, in which case $D\nablab c_1 = f(c_I)$, it is worth going into that mush details ? no.}
...
% Indeed, the exchange term $\nablabh c_1$ which is function of the local concentration $c_I$ at surfactant saturation \citep{manikantan2020surfactant}. 
