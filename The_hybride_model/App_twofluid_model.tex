...
Additionally, it is interesting to note that while $\textbf{u}_m$ is not divergence free \eqref{eq:dt_avg_rho}, the volume averaged velocity fields $\textbf{u}$ is. 
