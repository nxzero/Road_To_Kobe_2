...
To illustrate our approach, we then study the example of a viscous-dominated suspension of droplets, including non-uniform surface tension effects. 
...
An obvious perspective of this work is to use the surfaces Lagrangian-averaged equations to properly derive the transport equations for surfactant concentration (or temperature).  
