...
\citet{stone2001inertial} showed that in a dilute suspension of solid spherical particles immersed in a general linear flow, finite inertia gives rise to normal stresses . %which induce non-Newtonian behavior, while the effective viscosity remains consistent remains unchanged with respect to Einstein's original formula
%demonstrated that, in the case of general linear flow, the effect of finite inertia is to produce normal stresses, leading to non-Newtonian behavior, while the effective viscosity remains unchanged with respect to Einstein's original formula. 
