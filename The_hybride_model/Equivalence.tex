...
\begin{align}
    ...
    \label{eq:f_exp_exe}
\end{align}
meaning that $\phi_2\rho_2$ is in fact related to $\textbf{M}_p$ and the phase averaged velocity $\textbf{u}_2$ contains the first  moment of momentum $\textbf{P}_p$, which as discussed accounts for rotational and stretching motions of the particles. 
...
Then, by taking the Taylor expansion of each terms of $\mathbb{C}_2+\mathbb{C}_I$ we can equally show that,
\begin{equation}
    \mathbb{C}_2 
    + \mathbb{C}_I 
