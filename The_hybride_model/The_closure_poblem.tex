...
To obtain explicit closure we now need to compute the term $\bm\sigma^{1d}_f$ that is to say we need the conditioned averaged pressure and velocity fields.  
...
\section{The disturbance field equation}
