...
\subsection{Energy exchange closures}
...
\begin{align}
    &\pSavg{\textbf{w}_d^0 \cdot \bm{\sigma}_f^0\cdot\textbf{n}}
    =  \nonumber \\
    &\frac{1}{\lambda+1}\textbf{u}_{fp} \cdot \left[
        -\frac{1}{2}\pSavg{ \bm{\sigma}_f^0\cdot\textbf{n}}
        % + \pavg{\textbf{u}_{\alpha}' \cdot \intS{ \bm{\sigma}_f^0\cdot\textbf{n}} }
        + \frac{1}{2a^2}
        \pSavg{\textbf{rr}\cdot \bm{\sigma}_f^0\cdot\textbf{n}}
    \right]\nonumber
    \\
    &+ \frac{1}{\lambda+1} \left[
        ...
        % + \pavg{\textbf{u}_{\alpha}' \cdot \intS{ \bm{\sigma}_f^0\cdot\textbf{n}} }
        + \frac{1}{2a^2}
        \pavg{\textbf{u}_\alpha' \cdot \intS{\textbf{rr}\cdot \bm{\sigma}_f^0\cdot\textbf{n}}}
    \right] \nonumber
    \\
    % \left[
    %     \textbf{u}_{p f} \cdot
    ...
    &+ \frac{1}{\lambda + 1} \textbf{E}_{f} : \left[ 
         ...
         -\frac{1}{a^2} 
         \pSavg{ \textbf{rrr} \cdot \bm{\sigma}_f^0\cdot\textbf{n}}
         \right]
...
Consequently, in light of \ref{eq:energy_term} the work generated due to the local motion at the surface of a spherical droplet, namely  $\pSavg{\textbf{w}_d^0 \cdot \bm{\sigma}_f^0\cdot\textbf{n}}$ is either due to its relative motion with the continuous phase or due to its simple presence in a shear flow. 
...
\begin{align}
    ...
    % = 2\mu_d \intO{\textbf{e}_d^0: \textbf{e}_d^0 }
    = 
...
This finding motivates us to investigate the effect of inertia on the effective stress generated by translating droplets in dilute emulsions.
