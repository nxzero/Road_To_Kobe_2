...
\begin{equation}
<\grad \delta_I,\phi> = - <\delta_I,\grad \phi>.
\end{equation}
Hence,
\begin{equation}
<\grad \delta_I,\phi> = - \int_{\Gamma} \grad \phi d\Gamma.
...
which yields 
\begin{equation}
<\grad \delta_I,\phi> = - \int_{\Gamma} \grad (\phi \textbf{n}) \cdot \textbf{n} d\Gamma = <\grad (\delta _I \textbf{n}) \cdot \textbf{n},\phi>.
\end{equation}
