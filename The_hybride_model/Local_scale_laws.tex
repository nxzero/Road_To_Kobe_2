...
To derive a conservation equation for $\delta_I$, one can take the gradient of \ref{eq:dt_chi_k} and then compute the dot product of the resulting expression with $\textbf{n}_k$. This approach yields the following result \citep{marle1982,drew1990,lhuillier2000bilan,junqua2003}
...
\begin{equation}
<\frac{\partial \delta_I}{\partial x_i},\phi> = - <\delta_I,\frac{\partial \phi}{\partial x_i}>.
\end{equation}
Hence,
\begin{equation}
<\frac{\partial \delta_I,}{\partial x_i}\phi> = - \int_{\Gamma} \frac{\partial \phi}{\partial x_i} d\Gamma.
\label{eq:1grad_delta_I}
\end{equation}
Since $\textbf{n}$ is a unit vector, we have $\frac{\partial n_j}{\partial x_i}n_j =0$ and%. Inserting this relation in \ref{eq:1grad_delta_I} we obtain
\begin{equation}
\frac{\partial \phi }{\partial x_i}= \frac{\partial}{\partial x_i}(\phi n_j) n_j,
\end{equation}
which yields 
\begin{equation}
<\frac{\partial \delta_I}{\partial x_i},\phi> = - \int_{\Gamma} \frac{\partial}{\partial x_i}(\phi n_j) n_j d\Gamma = <\frac{\partial \delta_I n_j}{\partial x_i}n_j,\phi>.
\end{equation}
