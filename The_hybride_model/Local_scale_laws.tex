In this section, we derive the conservation equations using a two-fluid formulation. Although this formulation has been derived in various studies, such as those by \citet{kataoka1986local}, \citet{lhuillier2010multiphase}, \citet{ishii2010thermo}, \citet{morel2015mathematical}, and \citet{bothe2022sharp}, our approach allows us to introduce specific notations and key results that will be useful for later discussions.
...
To derive a conservation equation for $\delta_I$, one can take the gradient of \ref{eq:dt_chi_k} and then compute the dot product of the resulting expression with $\textbf{n}_k$. This approach yields the following result \citep{lhuillier2000bilan,junqua2003,orlando2023evolution}
