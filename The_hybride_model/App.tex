...
Indeed, the first term on the right-hands side of \ref{eq:exergysource} represents the work done by the mean dispersed-phase motion with the mean drag force.
...
A point-by-point review of each section is proposed to highlight the key findings, that have been made in this chapter: 
\begin{enumerate}
    ...
    \item In \ref{ap:particles_eq} we revisited the Lagrangian laws governing a single arbitrary fluid particle, drawing from Daniel Lhuillier's work. 
    The incorporation of surface tension properties into these equations seems new. 
    % Furthermore, the incorporation of surface tension effects, is original and offers a framework for describing deformable droplets. 
    \item \ref{ap:two-fluid_model} revisits the derivation of the two-fluid and single-fluid ensemble averaged equations for mass, momentum, and energy. 
    Most of this section was entirely exposed in the literature, although the averaged interfacial energy jump condition \eqref{eq:dt_avg_gamma} seems new.
    ...
    It seems that, regarding the energy conservation laws, this derivation as well as the subsequent discussions is original. 
