...
\begin{figure}[h!]
    ...
    (a) Rising sphere in uniform stokes flow (analytical solution in \ref{ap:Closure_problem}). 
    (b) Fixed droplet in extensional flow (analytical solution in \ref{ap:Closure_problem}).}
