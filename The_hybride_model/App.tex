...
\begin{multline*}
    ...
    \right]\\
    + C_1 \textbf{u}_{fp} \textbf{u}_{fp}
    + C_1 (\textbf{u}_{fp}\cdot \textbf{u}_{fp})\bm\delta
\end{multline*}
...
However, the funcitonal form of this tensor cannot be otherwise that proportional to $\textbf{u}_{fp} \textbf{u}_{fp}$ and $(\textbf{u}_{fp}\cdot \textbf{u}_{fp})\bm\delta$
...
\subsubsection{Work of the particles }
...
This term can be computed as well for the translating and sheared droplet it directly yields, 
\begin{equation*}
