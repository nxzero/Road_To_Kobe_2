...
In the averaged equation we will be neglecting the droplet inertia, thus all the terms of $\mathcal{O}(Re \phi)$ are not considered.
...
\begin{align}
    ...
    % + \mu_f a^2 \phi \frac{\lambda}{\lambda+1}\grad^2  [\grad \textbf{u}_f+ (\grad \textbf{u}_f)^\dagger]
