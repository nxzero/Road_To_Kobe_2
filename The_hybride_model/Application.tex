...
\JL{je ne suis pas trop fan du signe transposee qui est plutot useuellement utilise comme asterisque. }
...
They read, 
%\JL{pq lequation du second moment de la masse ne fait pas intervenir le moment angulaire (ni la trace du premier moment de la qdm) ?}
\begin{align}
...
\end{align}
In these equations we have introduced the rate of strain tensore $\textbf{e}_k^0 = 1/2 (\grad \textbf{u}_k^0 + \grad \textbf{u}_k^0)$. %as the local shear rate of phase $k$.
