...
It is then trivial \JL{evite ce mot} to show that from \ref{eq:hybrid_avg_dt_dV_alpha},\ref{eq:S_definition} and \ref{eq:V_definition} we obtain the second order moment of volume conservation,
\begin{multline}
    \pddt (\pnavg{\textbf{pp}})
    + \nablab \cdot (
...
\subsection{Compressible air bubble}
\JL{pour moi cette partie (certes interessante) parle pas dequation moyennee donc il faudrait plutot la mettre dans la section sur le lagrangien. D'ailleurs ca mettrait un peu de physique dans cette section ce qui serait un plus. Par contre je suis vraiment gene, car cette analogie a deja etait faite dans le cours de Lhuillier mais surtout dans le papier de Zhang et Prosperreti 1994 (PoF) Equation (88). Si on la mets il faudra bien specifier l'origine de celle-ci.}
...
\begin{equation}
    ...
    % = a_\alpha \textbf{n}_2\cdot\textbf{T}_1\cdot\textbf{n}_2 
