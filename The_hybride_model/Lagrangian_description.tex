...
\tb{which provides an indication that when the surface energy is changing the bulk
stress has some features characteristic of an elastic medium.
Batchlor }
...
\tb{commment of the impact of surface tensoin ofn the bulk stress }
