...
= 0$.
Therefore \ref{eq:dt_q_I_alpha} yields,%explains why $\bm\Phi_{\Gamma||}$ does not appear in \ref{eq:dt_q_I_alpha}. 
...
applying the chain rule yields \citep{lhuillier1998,lhuillier2009rheology}%we may write the partial time derivative of $\delta_\alpha$ can be written as
%\begin{equation}
