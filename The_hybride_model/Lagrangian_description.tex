...
\item pr moi il y a une erreur $\textbf{u}_2 \cdot \grad \textbf{r}$ est different de $\grad \textbf{r} \cdot \textbf{u}_2$. pr l'instant je n'ai pas modifie. A discuter ensemble. 
\end{itemize}
}
