...
The first effect that we study is the impact of the inertial effects on the particles' relative kinematics.  
...
Based on \ref{eq:particle_center_of_mass_velocities} we can show that the variance of the velocity in suspensions of spherical droplets does not diverge, even in Stokes regime unlike what is stated in the literature \citep{caflisch1985variance}. 
% This is because of the nearest pair distribution is normalized to $1$ unlike the classic pair distribution which is not. 
