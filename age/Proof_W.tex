...
A property particularly interes

% \subsection{The homogeneous and steady state assumption}

In homogeneous and steady state regime all variables are constant with the macroscopic variables \textbf{x} and $t$.   
...
This can be see as a constraint for the field $\textbf{w}_p^\text{nst}$. 
...
This equation describes the evolution of the particle mean interaction time. 

In this steady state and homogeneous regime this equation gives us the relation between the mean age of interaction $a_p$ and the mean rate of destruction $\tau_p$. 
