...
\begin{itemize}
    ...
    \tb{Equation 2.10 represents the distributional form of the interfacial transport equation. While we acknowledge that this terminology may not be entirely satisfactory, it follows the convention used by Teigen et al. (2009), and we have therefore chosen to retain it.} %Jean Lou know the ref $\to$ def a coter de l'eq}
