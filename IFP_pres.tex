...
\author{\href{http://basilisk.fr/sandbox/fintzin/Rising-Suspenion/RS.c}{\underline{N. Fintzi}\footnote{IFP energies nouvelles, France}, JL. Pierson$^1$} and S. Popinet\footnote{Sorbonne Universite, France}}
...
\begin{frame}
  ...
  \vfill
  This work focus on the study of \textbf{pair interaction} in oil/water \textbf{emulsion}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \includegraphics[height=0.25\textwidth]{image/HOMOGENEOUS/fDrop/F_mu_r_0_1_Ga_5_PHI_0_05.pdf}
...
\begin{columns}
  ...
  \begin{column}{0.5\textwidth}
    \begin{figure}[h!]
      ...
      \caption{Dimensionless particular Reynolds stress in terms of $Ga$ and $\phi$}
  \end{figure}
  \begin{equation}
