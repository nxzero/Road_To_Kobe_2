...
Thus the capillary force may be defined as : 
  ...
  In film drainage model it is assumed $\int_{S_c} \sigma\textbf{n}\kappa \; dS \approx 0 $
...
\begin{frame}
  ...
  \begin{equation}
    ...
    = \int_{\Omega_\alpha} \left(
        ...
        - \bm{\sigma}_2
    \right) d\Omega
    + \int_{\Sigma_\alpha} \textbf{r}\bm{\sigma}_2\cdot\textbf{n}_2 d\Sigma
\end{equation}
interfaces Jump conditions integrated  on the contact surface :
...
\begin{equation}
  ...
  d\Sigma
\end{equation}
If we make the assumption of quasi spherical surface with radius $a$ : 
\begin{equation}
  \int_{\Sigma_\alpha}
  \gamma (\textbf{I}-\textbf{nn})
  d\Sigma
