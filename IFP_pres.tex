...
$\rightarrow$ Consequently, the tensor $\mathbb{R}$ is plan isotope due to the form of $\mathbb{S}$.
...
\begin{itemize}
  ...
  \item Attraction forces acn leads to \textbf{instantaneous coalesence}. 
\end{itemize}
...
\section{Time of evolution of interactions dynamics}
