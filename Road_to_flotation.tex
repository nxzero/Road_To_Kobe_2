...
% \begin{equation}
%     \ddt  \intO{\delta(\textbf{x}+\textbf{r}-\textbf{x}_\beta) }
%     = \intO{\left[ \pddt \delta_\beta  + \div\left(\delta_\beta \textbf{u}_\beta \right) \right]}\\
%     + \intS{ \delta_\beta  (\textbf{u}_\Gamma^0-\textbf{u}_\beta)\cdot \textbf{n}_d }\\
%     \label{eq:reynolds_transport}
% \end{equation}
% Hence we may write, 
% \begin{equation}
%     \pddt (n_bP_b)
%     + \div  (n_bP_b\textbf{u}_b)
%     =
%     \pSavg{\delta_\beta (\textbf{u}_\Gamma^0 - \textbf{u}_\beta)\cdot \textbf{n}}
% \end{equation}
% What we are looking for is the input flow rate on bubble surface ! 
