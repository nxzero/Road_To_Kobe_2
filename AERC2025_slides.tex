...
% \textbf{IF}:
% \begin{equation}
%   Re=\frac{u_r \rho_f a}{\mu_{eff}} \gg \frac{\dot{\gamma}a}{u_r}
% \end{equation}
% % \begin{equation}
...
\begin{itemize}
  \item Hence, for non-buoyant bubbly flows the term $\propto \rho_f u_r^2$ is more relevant and represents the  contribution of the \underline{Stresslet} and \underline{Reynolds stress}
  \item Both contribution cannot be neglected for moderate volume fraction.
  ...
  % \item Particle-fluid-particles stress also contribute to the stress as $\propto u_r^2$
\end{itemize}
\end{frame}
