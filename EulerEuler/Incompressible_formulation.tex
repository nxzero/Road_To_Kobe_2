...
\section{The general form of the dispersed multiphase flow equaitons.}
...
%     +C_{[\grad^2 u]} \grad^2 \textbf{u}
%     \}\\
%     &- \div  \{\phi  C_{uu}^{(1)} \textbf{u}_{pf}\textbf{u}_{pf} 
%     + \phi C_{uu}^{(2)} (\textbf{u}_{pf}\cdot \textbf{u}_{pf}) \bm\delta \}
%     \\
%     \rho_f (\pddt 
%     + \textbf{u}\cdot \grad)
%     \textbf{u}
