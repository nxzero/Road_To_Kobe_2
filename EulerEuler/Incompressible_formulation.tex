...
However, one must take into account the additional stress generated due to the presence of particle if he wants to get rid of any approximation such as Boussinesq hypothesis.
...
Under this form \ref{eq:dt_np_final} can be interpreted as an advection of $n_p$ along the mixture phase velocity $\textbf{u}$, plus a source terms accounting for the non-zero drift fluxes of particle $\textbf{u}_r$. 
...
\subsection{Stokestain dilute emulsion}
