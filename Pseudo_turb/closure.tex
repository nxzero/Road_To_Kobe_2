...
Due to numerical constraint, we used a slightly higher \textit{Bond} number ($Bo = 0.5$) in this study, compared to the set of DNS used in \citet{fintzi2024buoyancy}. 
\begin{figure}[h!]
    \centering
