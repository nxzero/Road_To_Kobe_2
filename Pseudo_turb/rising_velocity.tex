...
In this part we briefly review the various formula used for the drag force on a spherical droplet embedded in a steady uniform flow. As we will see below the droplet remains approximatively spherical even in the highest inertial regime and this assumption remains valid for the whole range of parameters investigated presently (appendix ...). Theoretical prediction for the force on a spherical droplet are limited to the limit of very small and very high Reynolds number. In the Stokes flow regime the drag force on a spherical drop embedded in a steady uniform flow is given by the Hadamard-Ribczynski formula
