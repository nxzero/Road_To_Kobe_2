...
For a more detailed description of the solver we refer the reader to \citet{popinet2018numerical}. \todo{Make a more precise description such as in \cite{hidman2023assessing}}
...
\end{align}
respectively.  
\todo{mettre sous forme adim \citep{hidman2023assessing}}
