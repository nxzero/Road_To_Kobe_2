...
\todo[inline]{Should i put the number of realization is abs $\omega$}
...
\end{equation}
\todo{Introduce time average and volume average}
...
\todo[inline]{this convergence can be compared to Loisy studies}
