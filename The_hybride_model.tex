...
\begin{itemize}
\item regarder ou on utilise en premier les grands theoreme (Reynolds, Leibnitz, etc) et les definir aux bons moments.
\item quand est ce que l'on peut considerer que la densité interfaciale est nulle ?
\item je n'ai pas l'impression que dans la section II il y ait vraiment des résultats nouveaux (a toi de me dire). Je l'ai donc raccourci au maximum. 
\item quelles sont les nouveautés à bien mettre en exergue dans le modele Lagrangien ? a discuter ensemble mais il faut bien les faire ressortir
\item il y a pas mal de papier sur la rheologie du bulk d'écouleement a goutte. Mais peu qui font le distinguo entre les deux phases. Il faudra faire reference a ces papiers (Patankar et Hu, Li et Sarkar)
\item il faudra mettre les moments arbitraires en SM
\item il faut ajouter 2 sections une sur le bulk stress et une sur les équations d'energie.
\end{itemize}
}
...
% \input{The_hybride_model/Single_Ellipse_1.tex}
% \input{The_hybride_model/Single_Ellipse_3.tex}
% \input{The_hybride_model/Single_Ellipse_4.tex}
