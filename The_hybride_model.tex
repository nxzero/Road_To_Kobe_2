...
To further illustrate the methodology, we derive the mass, momentum, and the first two moment equations for droplets or bubbles suspended in a Newtonian fluid. 
In particular, we highlight the role second-order moment of the mass equation, which links droplet deformation to the stresslet. 
Finally, we derive closure laws in the dilute, viscous-dominated regime, with particular emphasis on the effects of surface tension gradients, and on how to compute the droplet deformation in this context.
\end{abstract}
...
\input{The_hybride_model/singularity_solution_appendix.tex}
