...
\nomenclature{$\nablabh$}{Local gradient operator}
\nomenclature{$\nablabh_I$}{Local interfacial gradient operator}
\nomenclature{$\nablab$}{Global gradient operator}
\nomenclature{$\nablabh\cdot$}{Local divergence operator}
\nomenclature{$\nablabh_I\cdot$}{Local interfacial divergence operator}
\nomenclature{$\nablab_\mathscr{C}\cdot$}{Divergence operator of the phase space}
\nomenclature{$\nablab\cdot$}{Global divergence operator}
