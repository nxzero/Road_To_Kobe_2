...
\nomenclature{$_f$}{Index of the continuous phase $f$}
\nomenclature{$_d$}{Index of the dispersed phase $d$}
\nomenclature{$_\alpha$}{Index of the particle $\alpha$}

\nomenclature{$f^0$}{Local non averaged quantity}
...
\nomenclature{$f^{nst}$}{Ensemble averaged quantity}
