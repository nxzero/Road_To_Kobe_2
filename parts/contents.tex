...
\nomenclature{$\textbf{n}_d$}{Normal vector pointing inward the dispersed phase}
\nomenclature{$\textbf{n}_f$}{Normal vector pointing inward the continuous phase}
...
\nomenclature{$_p$}{Subscript referring to the dispersed phase}
...
\nomenclature{$\textbf{w}_d^0$}{Center of mass relative velocity }
\nomenclature{$\textbf{r}$}{Center of mass relative position vector}
\nomenclature{$\textbf{M}_\alpha$}{Second moment of mass tensor}
\nomenclature{$\textbf{V}_\alpha$}{Second moment of volume tensor}
...
\nomenclature{$N$}{Total number of droplets}
