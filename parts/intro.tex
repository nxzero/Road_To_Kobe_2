...
In a second step, it is necessary to examine droplet-droplet interactions to better predict coalescence and breakup phenomena. % ,  consequently, the droplet size distribution.

These investigations require a combination of theoretical, numerical, and experimental data. %, leading to the development of models and a comprehensive understanding of the multiscale problem. 
...
The difference with the previous models is that the Eulerian-based exchange terms in the continuous phase equations are termed into Lagrangian-based exchange terms, which correspond exactly to the exchange terms appearing in the Lagrangian-based equations describing the dispersed phase. %makes the whole system consistent. 
