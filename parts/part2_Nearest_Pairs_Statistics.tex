...
Note that we need to derive $\pddt N_i$ which is, 
\begin{equation}
   \pddt N_i
    = 
    \sum_{j\neq i}
...
\subsubsection{Mesoscal continuous equations}
...
Now we need to compute the space derivative $\pddx h_i(\textbf{x},\CC)$ 
\begin{align*}
    \pddx h_i
    &= 
