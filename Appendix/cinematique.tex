\chapter{Proof on kinematics   shape, external forces and moments relations on deformable particle.}
\label{ap:cinematic}
...
Therefore, we obtain the following relation in the non-zero cases,
\begin{equation}
...
Indeed, the non-zero terms can be defined by the sum of all the possible product of $\delta$.
...
Moreover, for even order tensor we can note that the components non-zero are carried by Kronecker symbols which is the expression of isotropy of the particle. 
