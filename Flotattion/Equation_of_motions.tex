...
We consider a three-phase system: the mixture, the bubbles and the particles.
...
\begin{equation}
    \textbf{F}_{k}^{(0)} 
    % = \phi \frac{3}{4d}\rho_f |\textbf{u}_f - \textbf{u}_p|(\textbf{u}_f - \textbf{u}_p)  C_d(\lambda,Re_{fp},\phi)
