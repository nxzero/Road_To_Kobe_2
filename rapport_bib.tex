...
On another hand we revisit the derivation of (2.10) of \citet{batchelor1972sedimentation} which relates continuous phase ensemble-averaged quantities to conditionally averaged quantities, and show that it leads to an infinite error in most of the physical scenarios.   
...
\part{Nearest particle statistics: Analysis and modeling of the microstructure geometry, kinematic and dynamic in buoyant emulsion}
...
\part{Closure terms modeling for mono-disperse buoyant emulsion of droplets}
