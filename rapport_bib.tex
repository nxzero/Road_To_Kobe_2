...
\chapter{Pseudoturbulence in a mono disperse suspension of rising droplets (corrigendum in appendix)}
...
\chapabstract{
    ...
    Then, based on the DNS results \eqref{chap:DNS} and findings from the literature, we propose an extension of this model up to $\phi = 0.2$ and $Re = 100$. \footnote{This chapter is accompanied by a corrigendum presented in \ref{ap:corrigedum} following the review of the manuscript.}
}
\minitoc
...
\input{On_pseudo_turbulence/corrigedum.tex}
