...
\chapabstract{
    In this chapter we propose to expose and analyze the minimal set of equations to describe emulsions based on the Lagrangian-Eulerian models developed in the preceding Chapter. 
}
\minitoc
...
\minitoc
\tb{Make section as Intro 2 Reformulation ... The disturbance etc }
