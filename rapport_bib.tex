...
%%%%%%%%%%%%%%%%%%%%%%%%% CHAPITRE 4
\chapter{Averaged equations for deformable spheroidal fluid particles : Stress in homogeneous buoyant rising deformable bubbles suspension }
...
\section{The most simple formulation for the modeling of dispersed multiphase flows made of incompressible fluids}
