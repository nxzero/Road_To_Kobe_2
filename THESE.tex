...
\begin{frame}
  {Averaged description of dispersed two-phase flows}
...
\uncover<3>{Only $\boxed{\intS[]{\textbf{r} \bm\sigma \cdot \textbf{n}}}$ is needed not $\textbf{v}$ ! $\to$ \textbf{Reciprocal theorem} \citep{stone2001inertial}}
\end{frame}
...
\end{align*} 
\uncover<2>{
$C^{Re}_1$ and $C_1$ valid only for $\boxed{\phi \ll 1}$ and $\boxed{Re < 1}$
$\longrightarrow$
