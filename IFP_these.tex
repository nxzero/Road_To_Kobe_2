...
\begin{frame}
  {In this thesis we focus on three aspects of this problem :}
  \Large
  \begin{enumerate}
    \item Mathematical modeling of \textbf{averaged dispersed two phase flows} with a kinetic-theory model. 
    % \begin{itemize}
    ...
    % \end{itemize}  
    \item Performing Direct Numerical Simulations (DNS) of buoyant emulsion to close the present mathematical model. 
    % \begin{itemize}
...
\begin{frame}
  {In this thesis we focus on three main aspects of the problem :}
  \begin{enumerate}
    \item Mathematical modeling of averaged dispersed two phase flows with a kinetic-theory model. 
    \begin{itemize}
      \item What is the difference with the classical solid particle model ? (R. Jackson 1997, D.Z. Zhand and A. Prosperetti 1997)
      \item Does the surface tension play a role in the conservation equations ? 
      \item How to model non-spherical particles and possibly deforming particles ?. 
    \end{itemize}  
    \item Direct numerical simulations to close the mathematical model. 
    \begin{itemize}
      \item Provide closure terms for the averaged Navier Stokes equations such as the Drag force, Reynolds Stresss, Particle-fluid-Particle stress \ldots 
    \end{itemize}
    \item Direct numerical simulations to explain qualitatively and quantitatively the interaction between pair of droplets within an emulsion. 
    \begin{itemize}
      \item How to model theoretically the pair properties ? 
      \item How to define an interaction within space and time ? 
    \end{itemize} 
