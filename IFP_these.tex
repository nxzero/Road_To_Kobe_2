...
\begin{frame}
  ...
  \begin{tikzpicture}
    \node (img1) at (-0.1\textwidth,-0.35\textwidth) {\includegraphics[height=0.1\textwidth]{image/logo.png} \href{http://basilisk.fr}};
    ...
    \draw[->,very thick] (img1) to[bend left] (img3);
    \draw[->,very thick] (img2.east) -- (img3);
